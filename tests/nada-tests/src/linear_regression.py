...
# def adjdet(A: NadaArray, b: NadaArray, modulo: int):
...
def linsol(A: NadaArray, b: NadaArray, modulo: int):
    ...
    # raise Exception(type(detRA), type(detR_inv))
    detA = detRA * detR_inv
...
def linear_regression_zn(X: na.NadaArray, y: na.NadaArray, modulo: int):
    """
...
def nada_main():
    ...
    (w, b) = linear_regression_zn(X, y, PRIME)
